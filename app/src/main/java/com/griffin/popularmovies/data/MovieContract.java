...
public class MovieContract {
    ...
    public static final String PATH_MOVIE_DETAIL = "favorite_movies_detail";
    ...
    //Database table column Names
    public static final class FavoriteDetailMoviesEntry implements BaseColumns {

        //build uri
        public static final Uri CONTENT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_MOVIE_DETAIL).build();
        ...
        public static Uri buildMovieDetailUriFromIdMovie(int id){
            return CONTENT_URI.buildUpon().appendPath(Integer.toString(id)).build();
        }

        public static long getMovieDetailIdFromUri(Uri uri) {
            return Long.parseLong(uri.getPathSegments().get(1));
        }
