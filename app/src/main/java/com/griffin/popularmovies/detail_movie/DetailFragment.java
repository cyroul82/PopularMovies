 ...
 */
public class DetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<ExtraDetailMovie>{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //restore the previous state
            ...
            mExtraDetailMovie = savedInstanceState.getParcelable(DetailFragment.EXTRA_DETAIL_MOVIE);
        }
    }
    ...
    private void setExtraDetail(){
        ...
        for (int i=0 ; i < maxActors  ; i++){
            mTextViewActor.append(mMovie.getCasting().get(i).getName() + "  (" + mMovie.getCasting().get(i).getCharacter() + ")\n");
        }
        ...
        mMovie.setReviewMovieList(mExtraDetailMovie.getReviews());
        for (ReviewMovie reviewMovie : mMovie.getReviews()){
